...
trait Name
{
    ...
    public static function name($middle = false)
    {
        return self::first() . ' ' . ($middle ? self::first() . ' ' : '') . self::last();
    }

    public static function cfirst()
    {
        $names = [
    ...
    public static function cname($len = 0)
    {
        $len = $len > 1 ? $len : mt_rand(2, 3);
        ...
        return self::cfirst() . $middle . self::clast();
    }
}
